...
function store_reg(){
    ...
    if(store_name.length > 3 && $.isNumeric(store_phone) && url.length > 3 && pass(store_password) && pass(store_password_confirmation) && valmail(email) && valmail(store_display_email) && $("#store_email").attr('data-valid') == 'true' && $("#store_password_confirmation").attr('data-valid') == 'true'){
